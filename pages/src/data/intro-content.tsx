...
export const INTRO_STEPS: IntroStep[] = [
  ...
  },
  {
    ...
    content: [
      ...
      <>For reference (not financial advice), the creator has a public M1 Finance Pie at <a href="https://m1.finance/qXIMP69--CKl" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">m1.finance</a> (updated from time to time).</>
    ],
    chartType: 'none',
    showDisclaimer: true
  }
