...
- Version in `package.json` reflects the last release. Do not bump version during development — `/release` handles version bumps
- During development, changelog entries accumulate in `.changelogs/NEXT.md` (see `.changelogs/README.md` for format)
