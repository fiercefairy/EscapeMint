...
- Fixed timezone issue in holiday detection that could cause incorrect results in non-UTC timezones
- Holiday calculations now consistently use UTC methods to match the US Eastern Time normalization
